...
/* package haskell-prolog-0.1.0.0 */
#ifndef VERSION_haskell_prolog
#define VERSION_haskell_prolog "0.1.0.0"
#endif /* VERSION_haskell_prolog */
#ifndef MIN_VERSION_haskell_prolog
#define MIN_VERSION_haskell_prolog(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_prolog */
...
#define CURRENT_COMPONENT_ID "haskell-prolog-0.1.0.0-inplace-haskell-prolog"
